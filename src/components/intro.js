			...
			<div className="box bgColourGrey">
				<article>
					...
					<div class="leftAlign">
						...
						<p>
							I read many different manga's. Some of my favourites are "Sousou no Frieren" and "Onii-chan is done for". I've also watched lot's of different anime, such as Journey of Elaina, Princess Connect: ReDive, Love Live!, and Madoka Magica. I also like to collect figure's, and
							own several different figures.
						</p>
